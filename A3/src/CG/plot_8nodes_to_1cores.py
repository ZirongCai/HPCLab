...
my_xticks=[]
time1core=321.767
file = open("result_strong1to8nodes.txt", "r")
...
ax.set_ylabel("Speedup ($t_{singlecore}/t$)",color="blue",fontsize=14)
...
plt.savefig("../../figs/5.strong_3.png",dpi=300,bbox_inches="tight")
