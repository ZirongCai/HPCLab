...
#ifndef SWEWAVEPROPAGATIONBLOCKCUDA_AWAREMPI_HH_
#define SWEWAVEPROPAGATIONBLOCKCUDA_AWAREMPI_HH_

#include <cassert>
#include "SWE_BlockCudaAwareMPI.hh"

/**
 * SWE_WavePropagationBlockCudaAwareMPI is an implementation of the SWE_BlockCuda abstract class.
 ...
 */
class SWE_WavePropagationBlockCudaAwareMPI: public SWE_BlockCudaAwareMPI {
  //private:
  ...
  public:
    // constructor of SWE_WavePropagationBlockCudaAwareMPI
    SWE_WavePropagationBlockCudaAwareMPI(
    		int l_nx, int l_ny,
    		float l_dx, float l_dy);

    // destructor of SWE_WavePropagationBlockCudaAwareMPI
    ~SWE_WavePropagationBlockCudaAwareMPI();
...
#endif /* SWEWAVEPROPAGATIONBLOCKCUDA_AWAREMPI_HH_ */
