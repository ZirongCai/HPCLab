...
#ifndef __SWE_BLOCKCUDA_AWAREMPI_HH
#define __SWE_BLOCKCUDA_AWAREMPI_HH
...
/**
 * SWE_BlockCudaAwareMPI extends the base class SWE_Block towards  
 ...
 */
class SWE_BlockCudaAwareMPI : public SWE_Block {

    public:
        // Constructor und Destructor
        SWE_BlockCudaAwareMPI(int l_nx, int l_ny,
                float l_dx, float l_dy);
        virtual ~SWE_BlockCudaAwareMPI();
        ...
        virtual void initScenario(float _offsetX, float _offsetY,
         ...
         */
        const float* getCUDA_waterHeight() { return h.elemVector(); };
        /**
         *  @return	pointer to the array #hb (bathymetry) in device memory 
         */
        const float* getCUDA_bathymetry() { return b.elemVector(); };
