...
#--------------------64---------------------------------
with open("./profile/outputs/StrongScale_CUDA_64.txt","r") as out:
	lines = out.readlines()
...
#----------------------128-------------------------------
with open("./profile/outputs/StrongScale_CUDA_128.txt","r") as out:
	lines = out.readlines()
...
#--------------------256---------------------------------
with open("./profile/outputs/StrongScale_CUDA_256.txt","r") as out:
	lines = out.readlines()
...
#--------------------512---------------------------------
with open("./profile/outputs/StrongScale_CUDA_512.txt","r") as out:
	lines = out.readlines()
...
#--------------------1024---------------------------------
with open("./profile/outputs/StrongScale_CUDA_1024.txt","r") as out:
	lines = out.readlines()
...
#--------------------2048---------------------------------
with open("./profile/outputs/StrongScale_CUDA_2048.txt","r") as out:
	lines = out.readlines()
...
#--------------------4096---------------------------------
with open("./profile/outputs/StrongScale_CUDA_4096.txt","r") as out:
	lines = out.readlines()
...
#--------------------8192---------------------------------
with open("./profile/outputs/StrongScale_CUDA_8192.txt","r") as out:
	lines = out.readlines()
...
plt.legend()
plt.savefig("./profile/strongscalingCPU_CUDA.png",dpi=300,box_inches="tight")
...
# #plt.show();
plt.savefig("./profile/strongscalingCOMM_CUDA.png",dpi=300,box_inches="tight")