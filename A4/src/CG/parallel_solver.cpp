...
#define SCOREP_USER_FUNCTION 1
//#define SCOREP_USER_LOOP 1
...
//  SCOREP_USER_FUNC_BEGIN()
    ...
    if (param->rank == 0){
        ...
        {
#ifdef SCOREP_USER_LOOP
    SCOREP_USER_REGION_DEFINE(handle)
    SCOREP_USER_REGION_BEGIN(handle, "loop", SCOREP_USER_REGION_TYPE_LOOP)
#endif
            // q = A*d
